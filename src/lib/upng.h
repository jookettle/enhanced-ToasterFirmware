...
typedef enum upng_color_type { UPNG_CT_PALETTE = 1, UPNG_CT_COLOR = 2, UPNG_CT_ALPHA = 4 } upng_color_type;
...
void upng_rgb24bto18b(upng_s_rgb18b* dst,
                      upng_s_rgb24b* src);  // Converts 24bit-color(r8,g8,b8) into 18bit-color(r6,g6,b6)
void upng_rgb24bto16b(upng_s_rgb16b* dst,
                      upng_s_rgb24b* src);  // Converts 24bit-color(r8,g8,b8) into 16bit-color(r5,g6,b5)
