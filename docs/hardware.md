...
ESP32-S3는 `Adafruit MatrixPortal S3` 보드의 핀맵과 일치합니다. [여기](https://learn.adafruit.com/adafruit-matrixportal-s3/pinouts)를 참고해주십시오.
...
ESP32-S3 또는 PSRAM이 있는 ESP32를 사용하신다면 ESP-NOW를 직접 수신할 수 있습니다.
PSRAM이 없는 ESP32는 RAM 부족으로 동시 구동은 어렵습니다. 다른 ESP 보드와 I2C 연결을 통해 사용하도록 구성하는 것을 권장드립니다.
...
## VL53L1X
최대 4m 거리, 최대 50Hz 주기로 측정 가능한 레이저 ToF 센서입니다. 현재 NeoToasterFirmware에서 지원하는 유일한 Boop 센서이며, 다른 I2C 장치 처리로 인해 최대 30Hz 주기로 측정 가능합니다.



# 조도센서
**일반적으로 최대 밝기에서도 밝기가 충분하지 않으므로, 최대 밝기로 고정하여 사용하는 것을 권장합니다.**
